...
plot <- eval_calib$plot + theme_classic() + labs(colour = "Model")
tab <- eval_calib$tab
...
plot <- eval_eval$plot + theme_classic() + labs(colour = "Model")
tab <- eval_eval$tab
write.csv(tab, paste0(table_path, "EvalMean_Evaluation.csv"), row.names = TRUE)
ggsave(plot, file = paste0(figure_path, "EvalMean_Evaluation.png"), width = 7, height = 5)
...
plot <- eval_boxplot_algo_run$plot + theme_classic() + labs(fill = "Model",
                                                y = "Calibration")
...
tab <- eval_eval$tab
write.csv(tab, paste0(table_path, "EvalMean_Evaluation.csv"), row.names = TRUE)
ggsave(plot, file = paste0(figure_path, "EvalMean_Evaluation.png"), width = 10, height = 5)
