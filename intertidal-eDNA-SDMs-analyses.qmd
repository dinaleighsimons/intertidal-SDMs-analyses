...
current_projections_plot <- cowplot::plot_grid(
  ...
  semibalanus_combined_current_plot_TSS,
  chthamalus_visual_current_plot_TSS,
  chthamalus_combined_current_plot_TSS, ncol = 2, labels = c("(a) GBIF-only (SB)", "(b) GBIF-eDNA (SB)", "(c) GBIF-only (CM)", "(d) GBIF-eDNA (CM)"), align = "hv", label_fontface = "bold"
)

current_projections_plot

# Save the plot
ggsave(current_projections_plot, filename = "Figures/current_projections_plot.png", width = 12, height = 14, dpi = 300)
```
