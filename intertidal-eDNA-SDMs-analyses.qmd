...
plot <- eval_calib$plot + theme_classic() + labs(colour = "Algorithm")
tab <- eval_calib$tab
...
plot <- eval_eval$plot + theme_classic() + labs(colour = "Algorithm")
tab <- eval_eval$tab
...
plot <- eval_calib$plot + theme_classic() + labs(colour = "Type") + theme(legend.position = "bottom")
tab <- eval_calib$tab
...
plot <- eval_eval$plot + theme_classic() + labs(colour = "Type")
tab <- eval_eval$tab
write.csv(tab, paste0(table_path, "EvalMean_Evaluation.csv"), row.names = TRUE)
ggsave(plot, file = paste0(figure_path, "EvalMean_Evaluation.png"), width = 7, height = 5)
...
current_projections_plot <- cowplot::plot_grid(
  ...
  semibalanus_combined_current_plot_TSS,
  chthamalus_visual_current_plot_TSS,
  chthamalus_combined_current_plot_TSS, ncol = 2, labels = c("(a) Citizen-only (SB)", "(b) Citizen-eDNA (SB)", "(c) Citizen-only (CM)", "(d) Citizen-eDNA (CM)"), align = "hv", label_fontface = "bold"
)
