...
This is to make sure the random elements in models start from the same point every time. This will make our results reproducible. This is also done before any randomised element such as before each model.
...
arrow_data$future = arrow_data$future - 0.02
