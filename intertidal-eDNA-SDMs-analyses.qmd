...
joint_map <- cowplot::plot_grid(semibalanus_map, chthamalus_map, labels = c("a", "b"),rel_widths = c(1,1.5) )

joint_map

# Save the plot
ggsave(joint_map, filename = "Figures/chthamalus_semibalanus_map.png", width = 11, height = 6, dpi = 300)
```
...
We are going to build our models and forecasts using the `biomod2` package. We will build four models, visualise their outputs and forecast changes into the far future (2100).
...
data_semibalanus_visual_plot <- plot(myBiomodData_semibalanus_visual)

#data_semibalanus_visual_plot

# Save the plot
#ggsave(data_semibalanus_visual_plot, filename = "Figures/data_semibalanus_visual_plot.png", width = 8, height = 6, dpi = 300)
```
...
data_semibalanus_combined_plot <- plot(myBiomodData_semibalanus_combined)
#data_semibalanus_combined_plot

# Save the plot
#ggsave(data_semibalanus_combined_plot, filename = "Figures/data_semibalanus_combined_plot.png", width = 8, height = 6, dpi = 300)
```
...
data_chthamalus_visual_plot <- plot(myBiomodData_chthamalus_visual)
#data_chthamalus_visual_plot

# Save the plot
#ggsave(data_chthamalus_visual_plot, filename = "Figures/data_chthamalus_visual_plot.png", width = 8, height = 6, dpi = 300)
```
...
data_chthamalus_combined_plot <- plot(myBiomodData_chthamalus_combined)
#data_chthamalus_combined_plot

# Save the plot
#ggsave(data_chthamalus_combined_plot, filename = "Figures/data_data_chthamalus_combined_plot.png", width = 8, height = 6, dpi = 300)
```
...
myBiomodEM_semibalanus_visual <- BIOMOD_EnsembleModeling(
  ...
  metric.select.thresh = c(0.4, 0.65),
  metric.eval = c('TSS', 'ROC'),
  var.import = 2,
  EMci.alpha = 0.05,
...
#myBiomodProjectionFuture_semibalanus_visual <- BIOMOD_Projection(
  #bm.mod = myBiomodModelOut_semibalanus_visual,
  #proj.name = 'Future.semibalanus.visual',
...
# Compute differences
#myBiomodRangeSize_semibalanus_visual <- BIOMOD_RangeSize(
  #proj.current = myBiomodProj_semibalanus_visual,
  #proj.future = myBiomodProjectionFuture_semibalanus_visual,
  #metric.binary = 'ROC'
#)
