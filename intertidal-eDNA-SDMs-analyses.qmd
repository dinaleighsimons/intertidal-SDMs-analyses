...
myBiomodData_semibalanus_visual <- BIOMOD_FormatingData(
  resp.var = rep(1, nrow(pts_clean)) , # presence-only
  expl.var = enviro_vars_current,
  resp.xy = pts_clean, 
  resp.name = 'Semibalanus.balanoides',
  PA.nb.rep = 1, # Number of pseudo-absence sets (10 recom by biomd)
  PA.nb.absences = 3 * nrow(pts_clean), # Number of pseudo-absences (~3 x number of presences)
  PA.strategy = 'random',
  eval.resp.var = semibalanus_corrected_marclim_PA$Semibalanus.balanoides, # Evaluation responses (0/1)
  eval.resp.xy = semibalanus_corrected_marclim_PA[, c("lon", "lat")], # Evaluation locations,
...
myBiomodData_chthamalus_visual <- BIOMOD_FormatingData(
  ...
  PA.nb.absences = 3 * nrow(pts_clean), # Number of pseudo-absences (~3 x number of presences)
  PA.strategy = 'random',
  eval.resp.var = chthamalus_corrected_marclim_PA$Chthamalus.montagui, # Evaluation responses (0/1)
  eval.resp.xy = chthamalus_corrected_marclim_PA[, c("lon", "lat")], # Evaluation locations,
...
#### Prediction 1 (Semibalanus - visual)
...
#### Prediction 2 (Semibalanus - combined)
...
#### Prediction 3 (Chthamalus - visual)
...
#### Prediction 4 (Chthamalus - combined)
...
```{r}
#| label: forecast-model-semibalanus-visual
#| echo: true
...
myBiomodRangeSize <- BIOMOD_RangeSize(
  proj.current = myBiomodEMProj_semibalanus_visual,
  proj.future = myBiomodEMProjFuture_semibalanus_visual,
  metric.binary = "TSS"
)
...
#myBiomodProjectionFuture_semibalanus_combined <- BIOMOD_Projection(
  #bm.mod = myBiomodModelOut_semibalanus_combined,
  #proj.name = 'Future.semibalanus.combined',
  #new.env = enviro_vars_future,
  #models.chosen = 'all',
  #metric.binary = 'ROC',
...
#myBiomodProjectionFuture_chthamalus_visual <- BIOMOD_Projection(
  #bm.mod = myBiomodModelOut_chthamalus_visual,
  #proj.name = 'Future.chthamalus.visual',
  #new.env = enviro_vars_future,
  #models.chosen = 'all',
  #metric.binary = 'ROC',
  #build.clamping.mask = TRUE
...
#myBiomodProjectionFuture_chthamalus_combined <- BIOMOD_Projection(
  #bm.mod = myBiomodModelOut_chthamalus_combined,
  #proj.name = 'Future.chthamalus.combined',
  #new.env = enviro_vars_future,
  #models.chosen = 'all',
  #metric.binary = 'ROC',
  #build.clamping.mask = TRUE
