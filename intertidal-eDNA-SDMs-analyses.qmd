...
SB_assessment_plot <- cowplot::plot_grid(
  ...
  ncol = 2, 
  labels = c("a) Ensemble (Citizen-only)", 
             "b) Ensemble (Citizen-eDNA)", 
             "c) Algorithms (Calibration, Citizen-only)", 
             "d) Algorithms (Calibration, Citizen-eDNA)",
             "e) Algorithms (Evaluation, Citizen-only)",
             "f) Algorithms (Evaluation, Citizen-eDNA)"), 
  align = "v",
