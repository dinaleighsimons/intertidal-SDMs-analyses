...
future_projections_plot <- cowplot::plot_grid(
  SB_diff_plot_future,
  CM_diff_plot_future,
  ncol = 2, labels = c("a) Semibalanus balanoides", "b) Chthamalus montagui"), align = "hv", label_fontface = "italic"
)
...
Lat_bin_line_plot <- ggplot(
  ...
  aes(
    ...
    color = scenario,
    shape = species,
    group = interaction(species, scenario)
  )
) + 
  geom_line(size = 1) + 
  geom_point(size = 3) + 
  ...
  scale_color_manual(
    ...
    values = c("suitability_current" = "blue",
               "suitability_future"  = "red"),
