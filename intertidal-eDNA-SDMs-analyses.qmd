...
rock_ukash_rast <- rast(rock_ukash)
...
pr <- partialResponse(bc, presvals_semibalanus_corrected, "thetao_mean_2")
plot(pr[[1]], type="l")
```
...
plot(p) # obviously this need to be restircted to rocky areas
```
